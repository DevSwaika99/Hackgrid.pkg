...
var countDownDate_design = new Date("Apr 7, 2021 09:48:02").getTime();
var countDownDate_frontend = new Date("Apr 7, 2021 12:44:52").getTime();
var countDownDate_backend = new Date("Apr 7, 2021 12:44:55").getTime();
...
document.getElementById("time_d").innerHTML = `${days_d} Days ${hours_d} Hrs ${minutes_d} mins ${seconds_d} secs to go`
